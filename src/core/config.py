...
class Settings(BaseSettings):
    ...
    # ML Models
    model_retrain_threshold: float = Field(0.85, description="Accuracy threshold for retraining")
    ...
    enable_continuous_learning: bool = Field(True, description="Enable continuous learning")
